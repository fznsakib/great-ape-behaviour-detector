...
end_frame_file_path = f'../dataset/behaviour_annotations/{filename}/{filename}_frame_{end_frame}.xml'
...
for i in range(start_frame + 1, end_frame):
    ...
    coords = []
    xmin = round(start_frame_ape_coords[0] + ((end_frame_ape_coords[0] -  start_frame_ape_coords[0]) * (frame_no/no_of_frames)), 2)
    ymin = round(start_frame_ape_coords[1] + ((end_frame_ape_coords[1] -  start_frame_ape_coords[1]) * (frame_no/no_of_frames)), 2)
    xmax = round(start_frame_ape_coords[2] + ((end_frame_ape_coords[2] -  start_frame_ape_coords[2]) * (frame_no/no_of_frames)), 2)
    ymax = round(start_frame_ape_coords[3] + ((end_frame_ape_coords[3] -  start_frame_ape_coords[3]) * (frame_no/no_of_frames)), 2)
