...
if (len(sys.argv) != 6):
    ...
    print('python behaviour_labeller.py [filename] [start frame] [end frame] [ape id] [ape activity]')
    exit()
...
print(f'Successfully edited id of ape {old_ape_id} to ape {new_ape_id} from frames {start_frame} to {end_frame}!')
